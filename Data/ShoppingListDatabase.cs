...
namespace Florea_Daniel_Lab7.Data
{
    public class ShoppingListDatabase
    {
        ...
        public async Task<ListProduct> GetListProductByIdsAsync(int shoplistid, int productid)
        {
            var result = await _database.QueryAsync<ListProduct>(
